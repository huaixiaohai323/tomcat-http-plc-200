...
<html>
  ...
  <body style="text-align: center;">
  	<h1>新劲车间物联网</h1><hr>
  	<form action="${pageContext.request.contextPath }/servlet/FindCustByCondServlet6" method="POST">
  	...
  	<form action="${pageContext.request.contextPath}/servlet/BatchDelServlet6" method="POST">
