...
<html>
  ...
  <body style="text-align: center;">
  	<h1>新劲车间物联网</h1><hr>
  	<form action="${pageContext.request.contextPath }/servlet/FindCustByCondServlet4" method="POST">
  	...
  	<form action="${pageContext.request.contextPath}/servlet/BatchDelServlet4" method="POST">
